...
<body>
    ...
    <div class="container py-3">
        <div class="project" >
              ...
              To use the tool, the user first needs to specify the Project, an Orthomosaic file, a Boundary file,
              the sensor and platform that were used to take the Orthomosaic image and optionally a Canopy Height
              Model file. After choosing an Orthomosaic/Canopy Height Model file, the user can decide on
