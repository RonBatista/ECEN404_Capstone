        ...
        <div class="project" >
          ...
          <div class = "arrowpopup" >
            <span>* = Optional Files. Click
              ...
              To use the tool, the user first needs to select a Project along with a Platform and Sensor. After these
              are selected the user must then select an Orthomosaic file and Boundary file. A Canopy Height Model file
              can be selected but is not necessary. It is only necessary if you want to generate Canopy Volume or Canopy
              Height. After selecting all needed and wanted files, the user can decide on what canopy attributes
              to generate including the Canopy Cover, Canopy Height, Canopy Volume and Excess Greenness. Please remember that
              the Canopy Height and Canopy Height cannot be generated unless a Canopy Height Model file is selected. After clicking the
              "Generate Results" button, the user can then select the canopy attributes and file formats (Shape, GeoJSON, CSV and XLSX)
              they would like to download. The generated files are available to download through the "Download Generated Files"
                  ...
                  <div class="col-lg-12">
                      <label>Select Canopy Attributes to Generate:</label>
                            ...
                            <table id="product-table-0" class="table table-bordered">
                              ...
                              <tr>
                                <td style="">
                                  <input id="exg_cb" name="exg_cb" class="checkbox" type="checkbox" value="Exg" checked="" onchange="ToggleRowData_caTable();">
                                </td>
                                <td style="">
                                  <span>ExG</span>
                                </td>
            ...
            <label>Select result files to download:</label>
                  ...
                  <table id="product-table-0" class="table table-bordered">
                    <thead style="">
                      <tr style="color: white; background: black;">
                        <th style="border: none;">
                          <input id="check-all-formatsTable" class="checkbox" type="checkbox" checked="" onchange="ToggleAllRowData_formatsTable();">
                        </th>
                        <th style="border: none;">--Select All--</th>
                      </tr>
                    </thead>
                    <tbody id="product-list-0">
                      <tr>
                        <td style="">
                          <input id="csv_cb" name="csv_cb" class="checkbox" type="checkbox" checked="" onchange="ToggleRowData_formatsTable();"> <!--<input id="check-data-2-92" name="check-data-2" type="checkbox" checked="" onchange="ToggleRowData(2);">-->
                        </td>
                        <td style="">
                          <span>.csv</span>
                        </td>
                      ...
                      <tr>
                        <td style="">
                          <input id="xls_cb" name="xls_cb" class="checkbox" type="checkbox" checked="" onchange="ToggleRowData_formatsTable();"> <!--<input id="check-data-2-82" name="check-data-2" type="checkbox" checked="" onchange="ToggleRowData(2);">-->
                        </td>
                        <td style="">
                          <span>.xls</span>
                        </td>
                      ...
                      <tr>
                        <td style="">
                          <input id="geojson_cb" name="geojson_cb" class="checkbox" type="checkbox" checked="" onchange="ToggleRowData_formatsTable();"> <!--<input id="check-data-2-83" name="check-data-2" type="checkbox" checked="" onchange="ToggleRowData(2);">-->
                        </td>
                        <td style="">
                          <span>.geoJSON</span>
                        </td>
                      ...
                      <tr>
                        <td style=""><input id="shp_cb" name="shp_cb" class="checkbox" type="checkbox" checked="" onchange="ToggleRowData_formatsTable();"></td><td style=""> <!--<td style=""><input id="check-data-2-84" name="check-data-2" type="checkbox" checked="" onchange="ToggleRowData(2);"></td><td style="">-->
                          <span>.shp</span>
                        </td>
                      </tr>
                    </tbody>
